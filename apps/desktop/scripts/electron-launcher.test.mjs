...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/Agents in Cloud (Dev).app",
      "Agents in Cloud (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "Agents in Cloud (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Agents in Cloud (Dev).app/Contents/MacOS/Agents in Cloud (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Agents in Cloud (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/Agents in Cloud (Dev).app/Contents/MacOS/Electron'",
    );
