  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Agents in Cloud prerelease is available for nightly testers."
          : "A new Agents in Cloud latest release is available.",
...
).pipe(Command.withDescription("Post an Agents in Cloud release announcement to Discord."));
